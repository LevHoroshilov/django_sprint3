# Generated by Django 3.2.16 on 2025-02-19 17:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='category',
            name='created_at',
            field=models.DateTimeField(default='<built-in method today of type object at 0x10f37f9d0>', verbose_name='Добавлено'),
        ),
        migrations.AlterField(
            model_name='category',
            name='description',
        ...
        migrations.AlterField(
            model_name='post',
            name='pub_date',
            field=models.DateTimeField(default='<built-in method today of type object at 0x10f37f9d0>', help_text='Если установить дату и время в будущем — можно делать отложенные публикации.', verbose_name='Дата и время публикации'),
        ),
        migrations.AlterField(
            model_name='post',
            name='text',
